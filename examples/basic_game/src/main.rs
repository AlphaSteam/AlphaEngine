...
use game::Game;
use sys::{
    axes::Axis, cam::projection_perspective::ProjectionPerspective, game_object::GameObject,
    system::System,
};
...
fn start(system: &mut System) {
    ...
    let projection = ProjectionOrtho::new(0.0, 1080.0, 0.0, 1440.0, -500.0, 500.0);
    system.camera_mut().set_projection(projection);
    /*  system
    .camera_mut()
    .transform_mut()
...
fn update(_system: &mut System, _time_step: f32) {}
