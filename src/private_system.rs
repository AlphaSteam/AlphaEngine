...
impl  PrivateSystem  {
    ...
    self.event_loop.run(   move |ev, _, control_flow| {
        ...
        let _next_frame_time_f32 = Instant::now().elapsed().as_secs_f32() + Duration::from_nanos(16_666_667).as_secs_f32();
       ...
       // System::update(&display, &renderer,&game,next_frame_time_f32 );
